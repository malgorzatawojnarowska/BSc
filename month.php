...
<body>
  ...
  <div id="container">
    ...
    <div class="square">
        ...
        <?php
          ...
          try{
            ...
            if($polaczenie->connect_errno!=0){
              ...
              $sql = $polaczenie->query("SELECT * FROM Notatki WHERE IdPracownika='".$prac['IdPracownika']."' AND MONTH(Data)='".$m."' AND YEAR(Data)='".$y."'");
              while($row = mysqli_fetch_array($sql))
                echo '<a href="monthpokaz.php?n1='.$row['IdNotatki'].'">'.$row['Data'].' '.$row['Tytul'].'</a><br/>';
            }
          }
          catch(Exception $e){
      ...
      <a href="addnote.php" style="color:white">
        <div class="tile7">
          <i class="icon-note"></i>
          <br/>Dodaj notatkę
        </div>
